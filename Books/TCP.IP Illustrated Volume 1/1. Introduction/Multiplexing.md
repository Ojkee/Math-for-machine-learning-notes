The process of combining data from multiple sources (applications or processes) into a single transmission over the network, allowing multiple data streams to share one connection.
